...
// Auth information
global.pairNumber = "3584573985814";                         // Add your paining number with country code example "916297175943"; 
...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["923164413714", "923164413714"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["923164413714", "923164413714"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["923164413714"];
